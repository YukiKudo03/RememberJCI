...
# Authentication framework [https://github.com/heartcombo/devise]
gem "devise"
...
# Version tracking for ActiveRecord models [https://github.com/paper-trail-gem/paper_trail]
gem "paper_trail"
...
group :development do
  ...
  # Add model annotations to files
  gem "annotaterb"
end
